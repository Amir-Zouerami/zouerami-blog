  ...
  return (
    <section className="container mx-auto max-w-[1000px]">
      ...
      <div className="mx-auto flex justify-center px-5 lg:max-w-[600px]">
        <div>
          <Event year="۱۳۹۳" title="دیدن اولین خط کد در تلویزیون!" />
          ...
          <Event
            ...
            title="الگوریتم و ساختمان داده"
            text="انگار هنوز هیچی از برنامه نویسی یاد نداشتم! تازه شروع به حل سوالات leetcode و یاد گرفتن راجع به الگوریتم ها کرده بودم. در
            در کنار این ها با Deno هم آشنا شدم."
          />
          ...
          <Event
            ...
            title="اولین پروژه ی اوپن سورس: grammY.dev"
            text="این سال بود که با آقای Steffen Trog آشنا شدم. ایشون با چند نفر دیگه در حال کار روی یک فریم ورک برای ربات های تلگرامی بود که واقعا از بقیه ی فریم ورک ها پیشرفته تر محسوب می شد.
          ...
          <Event
            year="۱۴۰۲"
            title="آزادی!"
            text="نوبتی هم باشه نوبت برگشت به دنیای برنامه نویسیه!"
          />
        </div>
      </div>
      ...
      <div className="mt-20 px-5">
        <p className="text-justify leading-loose">
          ...
          برای جزئیات بیشتر از پروژه ها و مسائل فنی شون به بخش پورتفولیو سایت
          برید.
        </p>
      </div>
    </section>
