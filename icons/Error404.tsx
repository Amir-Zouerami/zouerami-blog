const Error404 = ({ margin }: { margin?: string }) => (
  <svg
    id="404-Dave"
  ...
  >
      ...
      <g id="Dave">
        ...
        <g id="Eyes" fill="#263D52">
          <circle
            id="eyes-left"
            style={{
              transformOrigin: '256.4px 114.3px',
            }}
          ...
          <circle
            id="eyes-right"
            style={{
              transformOrigin: '294.3px 114.3px',
            }}
            className="blinking-eyes"
            cx={294.3}
            cy={114.3}
    ...
    <g fill="#263D52" id="Numbers" className="dark:svgNumbers404">
